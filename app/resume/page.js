        ...
        <main className={styles.main}>
              ...
              <div className={styles.timeline}>
                <div className={styles.timelineItem}>
                  ...
                  <div className={styles.timelineContent}>
                    ...
                    <div className={styles.companyName}>XX光電</div>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.autobiography}>
              ...
              <p className={styles.paragraph}>
                畢業後，我進入XX擔任設備與製程工程師，在這個角色中，我負責設備維護和改善製程參數以提高良率。這段工作經驗培養了我的數據分析能力、問題解決思維和團隊協作精神。我在職期間成功將生產良率提高5%，獲得部門主管的肯定。
              </p>
              <p className={styles.paragraph}>
                然而，我始終對程式開發保持熱情。在XX工作的兩年間，我持續利用下班時間自學前端技術，並開始構思未來的職涯規劃。我發現自己對前端開發的熱情遠超過現有工作，所以在2024年初，因應公司的人力結構調整，我做出了轉職的決定。
              </p>
              <p className={styles.paragraph}>
